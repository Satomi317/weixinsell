package com.bitekeji.weixinsell.aspect;

import com.bitekeji.weixinsell.util.CookieUtil;
...
public class SellerAuthAspect {
    ...
    @Pointcut("execution(public * com.bitekeji.weixinsell.controller.Seller*.*(..))" +
            "&& !execution(public * com.bitekeji.weixinsell.controller.SellerLoginController.*(..))")
    public void verify(){}
    @Before("verify()")
